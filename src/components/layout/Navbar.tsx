    ...
    >
      <div className={`glass px-6 py-3 rounded-full flex items-center justify-between w-full max-w-5xl transition-all duration-300 ${isScrolled ? 'border-white/10 bg-black/40' : 'border-transparent bg-transparent'}`}>
        ...
        <div className="flex items-center gap-3">
          <a
            href="https://wa.me/923288091852"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white rounded-full glass border border-white/10 hover:border-green-400/50 hover:bg-green-400/10 transition-all group hover-target"
          >
